...
from networks import Ablation1
...
def main(rank, config_path: str, world_size: int):
    ...
    if rank == 0:
        print(
            "[+] Ablation Study #1: Virtual Instance vs. Group Context\n",
            "Hypothesis: Usage of Group Context is more beneficial than the case of Virtual Instance\n",
            "            due to abundant semantic information\n",
        )
