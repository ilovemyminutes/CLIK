...
class NonLinearMLP(nn.Module):
    ...
    def __init__(self, input_dim: int, output_dim: int = 128, hidden_dim: int = None, activation: str = 'ReLU'):
...
class ImageEncoder(nn.Module):
    ...
    def __init__(self, name: str = 'resnet50', output_dim: int = 128, pretrained: bool = True):
...
class TextEncoder(nn.Module):
    ...
    def __init__(self, name: str = 'dsksd/bert-ko-small-minimal', output_dim: int = 128, pretrained: bool = True):
        super(TextEncoder, self).__init__()

        # BERT-variants: depends on transformers (https://huggingface.co/docs/transformers/index)
        self.enc = (
